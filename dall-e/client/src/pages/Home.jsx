    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div>
                ...
                <p className='mt-2 text-[#666e75] text-[14px] max-w-[500px]'>Browse throrugh a Collection of visually stunning Images generated by DALL-E AI</p>
            </div>
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>
                            {searchText ? (
                                <RenderCards data={searchedResults} title="No searach results found" />) :
